...
class IPCamera:
    ...
    def _setup_fallback(self):
        ...
        # Generate some test frames (colored frames with text)
        self.fallback_frames = []
        ...
        for i, color in enumerate(colors):
            ...
            frame[:] = color
            # Add camera name
            cv2.putText(frame, f"{self.name} - TEST MODE", (50, 50), 
                       cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
            cv2.putText(frame, "Camera not connected", (50, 100), 
                       cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
            cv2.putText(frame, f"Frame {i+1}", (50, 150), 
                       cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
            
            # Add test people boxes (simulating workers)
            if i % 2 == 0:
                cv2.rectangle(frame, (100, 200), (180, 350), (255, 255, 255), 2)
                cv2.putText(frame, "Test Worker 1", (100, 190), 
                           cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
                
                cv2.rectangle(frame, (400, 250), (480, 400), (255, 255, 255), 2)
                cv2.putText(frame, "Test Worker 2", (400, 240), 
                           cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
                
                # Add test machinery
                cv2.rectangle(frame, (300, 300), (380, 380), (0, 165, 255), 2)
                cv2.putText(frame, "Test Machine", (300, 290), 
